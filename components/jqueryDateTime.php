...
class jqueryDateTime extends CInputWidget {
    ...
    function run() {
        ...
        Yii::app()->clientScript->registerScriptFile($assetUrl . '/js/jquery.datetimepicker.js');
        Yii::app()->clientScript->registerCssFile($assetUrl . '/css/jquery.datetimepicker.css');
